...
class SearchRun(Base):
    ...
    skipped_region: Mapped[int] = mapped_column(Integer, default=0, nullable=False)
    skipped_unknown_region: Mapped[int] = mapped_column(Integer, default=0, nullable=False)
...
class SenderAccount(Base):
    ...
    verification_error_category: Mapped[str | None] = mapped_column(String(30))
    verification_retry_at: Mapped[datetime | None] = mapped_column(DateTime(timezone=True))
    imap_verification_status: Mapped[str] = mapped_column(String(30), default="unverified", nullable=False)
    imap_verification_error: Mapped[str | None] = mapped_column(Text)
    imap_verification_checked_at: Mapped[datetime | None] = mapped_column(DateTime(timezone=True))
