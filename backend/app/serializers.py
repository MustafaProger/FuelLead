...
def search_run_to_dict(run: SearchRun) -> dict:
    return {
        ...
        "active_provider": run.active_provider,
        "search_requests": run.search_requests,
        "company_requests": run.company_requests,
        "progress_message": run.progress_message,
        "provider_results": run.provider_results,
        ...
        "skipped_known": run.skipped_known,
        "skipped_region": run.skipped_region,
        "skipped_unknown_region": run.skipped_unknown_region,
